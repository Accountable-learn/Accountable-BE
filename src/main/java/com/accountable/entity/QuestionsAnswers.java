...
/**
 * Each object can identify all the questions a user answers (fks) and their corresponding answers
 * (json). A teacher can also attached their feedback to the entity for feedback *
 */
@NoArgsConstructor
@AllArgsConstructor
@Getter
